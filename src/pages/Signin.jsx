...
export function Signin(props) {
  ...
  const isFieldValid = {
    email:
      signinData.email === ""
        ? undefined
        : validateEmail(signinData.email.trim()),
    password:
      signinData.senha === "" ? undefined : validatePassword(signinData.senha),
  };
  ...
  return (
    <div>
      <SecondHeader />
      <div className="w-full h-full bg-none grid lg:grid-cols-2 grid-cols-1 items-center justify-center mt-20 lg:mt-0">
        <div className="flex items-center justify-center">
          <img
            src="https://media.discordapp.net/attachments/1077345452694970438/1099732041794326698/Component_26.png?width=480&height=480"
            alt=""
            className="sm:w-[480px] w-[350px] sm:ml-[100px] hidden lg:inline-block"
          />
        </div>
        <div className="h-[500px] flex items-center justify-center">
          <Card
            ...
            className="w-[351px] h-full bg-gray-100 dark:bg-gray-800
                            flex - items-center justify-evenly p-6 shadow-lg sm:mr-[100px] lg:ml-0 mr-8 ml-8 lg:mb-0 mb-12
                            dark:shadow-xl
                        "
          >
            <Typography
            ...
            <form className="mt-8 mb-2 w-full  flex items-center flex-col">
              ...
              <GnButton
                ...
                onClick={signIn}
                disabled={
                  !Object.values(isFieldValid).every((value) => value === true)
                }
              >
                {t("signIn")}
              </GnButton>
              <Typography className="mt-6 text-center font-normal text-gray-900 dark:text-gray-200">
                ...
                <Link
                  to="/cadastro"
                  className="font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-100  to-purple-300
