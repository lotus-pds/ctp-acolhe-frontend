...
import {
    ...
    postSubscribe,
} from "../services/subscribe-signin";
...
export function Subscribe(props) {
  ...
  const [subscription, setSubscription] = useState({
    ...
    confirmacao: "",
    urlAvatar:
      "https://cdn.discordapp.com/attachments/1077345452694970438/1133510052779667538/ctp-bot.png",
  });
  ...
  const isFieldValid = [
    {
      name:
        subscription.nome === ""
          ? undefined
          : validateName(subscription.nome.trim()),
      email:
        subscription.email === ""
          ? undefined
          : validateEmail(subscription.email.trim()),
      registration:
        subscription.prontuario === ""
          ? undefined
          : validateRegistration(subscription.prontuario.trim()),
      password:
        subscription.senha === ""
          ? undefined
          : validatePassword(subscription.senha),
      passwordConfirmation:
        subscription.confirmacao === ""
          ? undefined
          : subscription.confirmacao == subscription.senha &&
            validatePassword(subscription.confirmacao),
    ...
    },
    {
      phoneNumber:
        subscription.telefone === ""
          ? undefined
          : validatePhoneNumber(subscription.telefone.trim()),
      class:
        subscription.turma === ""
          ? undefined
          : validateClass(subscription.turma.trim()),
  ...
  return (
    <div>
      ...
      <div className="w-full h-full bg-none grid lg:grid-cols-2 grid-cols-1 items-center justify-center mb-12 mt-8 md:mt-0">
        <div className="h-[500px] flex items-center justify-center sm:mt-12 mb-12">
          <Card
            color="transparent"
            shadow={true}
            ...
            <form className="mt-5 mb-2 w-full  flex items-center flex-col">
              ...
              <div className="flex gap-5 p-3 w-full justify-center align-center">
                ...
                <GnButton
                  ...
                  variant="gradient"
                  onClick={() =>
                    subscription.email.includes("@ifsp.edu.br")
                      ? subscribe()
                      : step === 1
                      ? setStep(step + 1)
                      : subscribe()
                  ...
                  disabled={
                    !Object.values(isFieldValid[step - 1]).every(
                      (value) => value === true
                    )
                  }
                >
              ...
              <Typography className="mt-4 text-center font-normal text-gray-900 dark:text-gray-200">
                ...
                <Link
                  to="/acesso"
                  className="font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-200  to-green-400
                                dark:from-green-300 dark:to-green-400
                            "
                >
                  {t("signIn")}
        ...
        <div className="flex items-center justify-center">
          <img
            src="https://media.discordapp.net/attachments/1077345452694970438/1097572563443531856/subscribe-img.png?width=480&height=480"
            alt=""
