...
export function Terms(){
    return(
        <div className="flex flex-col p-16 gap-8 mt-[-24PX] items-center h-full justify-evenly">
            <Logo/>
            <Typography variant="h1" className="font-mouse font-normal">Termos e condições de uso do CTP Acolhe</Typography>
            ...
            <Typography variant="h5" className="">1. DA FUNÇÃO DO SITE</Typography>


            <Typography variant="small" className="">Este site foi criado e desenvolvido com a função de trazer conteúdo informativo de alta qualidade, a venda de produtos físicos, digitais e a divulgação de prestação de serviço. A EMPRESA busca através da criação de conteúdo de alta qualidade, desenvolvido por profissionais da área, trazer o conhecimento ao alcance de todos, assim como a divulgação dos próprios serviços.
            ...
            <Typography variant="h5" className="">2. DO ACEITE DOS TERMOS</Typography>
            <Typography variant="small" className="">Este documento, chamado “Termos de Uso”, aplicáveis a todos os visitantes do site, foi desenvolvido por Diego Castro Advogado – OAB/PI 15.613, modificado com permissão para este site.
            ...
            <Typography variant="h5" className="">3. DO GLOSSÁRIO</Typography>

            <Typography variant="small" className="">Este termo pode conter algumas palavras específicas que podem não se de conhecimento geral. Entre elas: <br/>
            ...
            <Typography variant="h5" className="">4. DO ACESSO AO SITE</Typography>

            <Typography variant="small" className="">O Site e plataforma funcionam normalmente 24 (vinte e quatro) horas por dia, porém podem ocorrer pequenas interrupções de forma temporária para ajustes, manutenção, mudança de servidores, falhas técnicas ou por ordem de força maior, que podem deixar o site indisponível por tempo limitado.
            ...
            <Typography variant="h5" className="">5. DA LICENÇA DE USO E CÓPIA</Typography>

            <Typography variant="small" className="">O visitante poderá acessar todo o conteúdo do website, como artigos, vídeos, imagens, produtos e serviços, não significando nenhum tipo de cessão de direito ou permissão de uso, ou de cópia dos mesmo.
            ...
            <Typography variant="h5" className="">6. DAS OBRIGAÇÕES</Typography>

            <Typography variant="small" className="">O VISITANTE ao utilizar o website da EMPRESA, concorda integralmente em:
            ...
            <Typography variant="h5" className="">7. DA MONETIZAÇÃO E PUBLICIDADE</Typography>

            <Typography variant="small" className="">A EMPRESA pode alugar ou vender espaços publicitários na plataforma, ou no site, diretamente aos anunciantes, ou através de empresas especializadas com o Adsense (Google), Taboola ou outras plataformas especializadas como o Eletro Criticas
            ...
            <Typography variant="h5" className="">8. DOS TERMOS GERAIS</Typography>

            <Typography variant="small" className="">O Site irá apresentar hiperlinks durante toda a sua navegação, que podem levar diretamente para outra página da EMPRESA ou para sites externos.
            ...
            Este Termo de uso é valido a partir de 01 de junho de 2023.
            </Typography>
